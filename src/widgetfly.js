...
(function (root, factory) {
		...
		if (!Utils.inIframe()) {
			...
			Utils.inherit(Widgetfly.Panel,Widget);
			...
			Utils.inherit(Widgetfly.Modal,Widget);
			...
			Utils.inherit(Widgetfly.Popover,Widget);
			...
			Widgetfly.Panel.extend = Widgetfly.Modal.extend = Widgetfly.Popover.extend = extend;
